...
<head>
	...
	<link rel="icon" type="image/png" href="images/tab11.png" sizes="16x16">
	<link rel="icon" type="image/png" href="images/tab11.png" sizes="32x32">
		...
		<header id="header" class=" full-header" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.php?pag=home" class="standard-logo" data-dark-logo="images/logo1.jpg"><img src="images/logo1.jpg" alt="LearnCraft"></a>
						<a href="index.php?page=home" class="retina-logo" data-dark-logo="images/logo1.jpg"><img src="images/logo1.jpg" alt="LearnCraft"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu" class="dark">
						...
						<ul>
							<li><a href="index.php?page=home"><div>Home</div></a></li>

							<li><a href="index.php?page=course"><div>Courses</div></a>
								<ul>
							...
							<li><a href="index.php?page=team"><div>Team</div></a>
										...
										<ul>
											...
											<li class="mega-menu-title"><a href="index.php?page=team"><div>Chairman</div></a></li>
											<li class="mega-menu-title"><a href="index.php?page=team"><div>CEO</div></a></li>												

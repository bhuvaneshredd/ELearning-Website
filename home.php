						...
						<div class="swiper-slide dark">
							<div class="container clearfix">
								<!-- <div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp">We are Exceptional</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200"></p>
								</div> -->
							</div>
							<div class="video-wrap">
								<img src="images/slider/Slide116.jpg">
					...
					<div class="row clearfix">
						...
						<div class="col-lg-5">
							<div class="heading-block topmargin">
								<h1>Welcome to LearnCraft</h1>
							</div>
							<p class="lead">We the group of LearnCraft, our aim is to promote education. If you are a student, then contact us to secure your future. We deliver free international standard video lectures and content.</p>
						</div>

						<div class="col-lg-7">

							<div style="position: relative; margin-bottom: -60px;" class="ohidden" data-height-lg="426" data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
								<img src="images/services/img.jpg" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="100" alt="Chrome">

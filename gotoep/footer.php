<!-- Footer
		============================================= -->
		<footer id="footer" class="dark" style="margin-top: 80px;>
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half col_last tright">
						...
						<i class="icon-envelope2"></i> learncraftinfo@gmail.com<span class="middot">&middot;</span> <i class="icon-headphones"></i> 1234-1234567<span class="middot"></span>
					</div>

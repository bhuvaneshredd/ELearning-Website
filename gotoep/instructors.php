        ...
        if($power == 'yes'){ //*************************
            ...
            if (isset($_FILES["profilePic"]["name"]) && !empty($_FILES["profilePic"]["name"])) {
                ...
                if ($_FILES["profilePic"]["error"] !== UPLOAD_ERR_OK) {
                    $message_picture  = '<b class="text-danger">Error during file upload: ' . $_FILES["profilePic"]["error"] . '</b>';
                    $uploadOk = 0;
                }
                ...
                if ($uploadOk != 0) {
                    ...
                    if (move_uploaded_file($_FILES["profilePic"]["tmp_name"], $target_dir . $newfilename)) {
                        ...
                        $message_picture =  '<b class="text-danger">Sorry, there was an error uploading your file</b>';
                    }
                }

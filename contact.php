...
<?php
	...
	if( ( isset($name) && !empty($name) ) && ( isset($email) && !empty($email) ) && ( isset($user_msg) && !empty($user_msg) ) && ( isset($phone) && !empty($phone) ) ) {
		...
		$to = "learncraft@gmail.com"; //Programmers email
		
		if(mail($to,$subject,$message)){
			
			$success= "<div class='alert alert-sucess'> Thank You For Your Feedback.<a class='close' data-dismiss='alert'>&times</a></div>";

		} else {
			$send_error = '<b class="text-danger text-center">Fail to send Mail. Please check Your Email Address&#44; Name &amp; Fill the message BOX. </b>';
		} 
		
		$header  = "learncraft@gmail.com";
		$subject = "Thank You $name";
		$message = "We are here for achieve your expectations. \nThank you for your FEEDBACK Form LearnCraft.\n CEO EP";
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="sidebar col_last nobottommargin">
						...
						<abbr title="Email Address"><strong>Email:</strong></abbr> learncraft@gmail.com
